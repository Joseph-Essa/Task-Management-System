...
public class Admin_CoursesFrame extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        btnAddCourse.setBackground(new java.awt.Color(51, 51, 51));
        btnAddCourse.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        btnAddCourse.setForeground(new java.awt.Color(204, 204, 204));
        btnAddCourse.setIcon(new javax.swing.ImageIcon("D:\\FCAI\\Year (2)\\Semester (1)\\Computer Programming-2\\Project_1\\New folder\\add7.png")); // NOI18N
        btnAddCourse.setText("Add New Task");
        btnAddCourse.setBorderPainted(false);
        btnAddCourse.setContentAreaFilled(false);
        btnAddCourse.setDefaultCapable(false);
        ...
        btnList.setText("List All Tasks");
